...
MTL-GCN framework codes consist of folder'`utils`', file '`build_graph_dataset.py`' and '`AqTox_MTL_GCN.py`'.The `utils` file contains the codes related to molecular graph encoding and the model architecture.

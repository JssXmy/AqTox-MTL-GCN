...
def calculate_maccs_fingerprint(smiles):
    ...
    Returns:
    list: 二进制指纹列表 (167位)，如果SMILES无效则返回None
    """
    try:
        # 从SMILES创建分子对象
...
def process_excel_file(input_file, output_file=None, smiles_column='SMILES'):
    """
    处理Excel文件，计算MACCS指纹并保存结果
    ...
    fp_columns = [f'MACCS_{i:03d}' for i in range(n_bits)]
    ...
    if output_file is None:
        ...
        output_file = f"{base_name}_MACCS.xlsx"
